...
func createLCOWContainer(coi *createOptionsExInternal) (Container, error) {
	...
	c, err := createContainer(coi.actualId, hcsDocument, coi.actualSchemaVersion)
	if err != nil {
		c.(*container).operatingSystem = "linux"
	}
	return c, err
}
